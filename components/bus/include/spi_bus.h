...
/**
 * @brief Deinitialize and del the spi bus
 *
 * @param p_bus_handle pointer to spi bus handle, if del succeed handle will set to NULL.
 * @return esp_err_t
 ...
 *
 * @param p_dev_handle pointer to device handle, if del succeed handle will set to NULL.
 * @return esp_err_t
 *     - ESP_ERR_INVALID_ARG   if parameter is invalid
 *     - ESP_FAIL Fail
 *     - ESP_OK Success
