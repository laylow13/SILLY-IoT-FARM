 ...
 *
 * @param p_bus_handle Point to the I2C bus handle, if del succeed handle will set to NULL.
 * @return
 *     - ESP_OK Success
 *     - ESP_FAIL Fail
 */
 ...
 *
 * @param p_dev_handle Point to the I2C device handle, if del succeed handle will set to NULL.
 * @return
 *     - ESP_OK Success
 *     - ESP_FAIL Fail
 */
